...
[![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FMIMBCD-UI%2Favi-2020-short-paper&count_bg=%236EC73F&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=true)](https://hits.seeyoufarm.com)
...
In this repository, we present the files from our [published short paper](https://dl.acm.org/doi/10.1145/3399715.3399744) [DOI: [10.1145/3399715.3399744](https://doi.org/10.1145/3399715.3399744)] on the [AVI 2020](https://dl.acm.org/conference/avi) ([website](https://sites.google.com/unisa.it/avi2020)) conference. The publication is related to our [User Tests and Analysis 4 (UTA4)](https://github.com/MIMBCD-UI/meta/wiki/User-Research#test-4-single-modality-vs-multi-modality-) study. This repository also concerns the publication of several *datasets* regarding *usability* ([SUS](https://en.wikipedia.org/wiki/System_usability_scale)), *workload* ([NASA-TLX](https://en.wikipedia.org/wiki/NASA-TLX)), *time*, severity *rates* ([BIRADS](https://en.wikipedia.org/wiki/BI-RADS)) and *medical imaging* results of clinicians from our [User Tests and Analysis 4 (UTA4)](https://github.com/MIMBCD-UI/meta/wiki/User-Research#test-4-single-modality-vs-multi-modality-) study. That said, we created [UTA4: SUS Dataset](https://mimbcd-ui.github.io/dataset-uta4-sus), [UTA4: NASA-TLX Dataset](https://mimbcd-ui.github.io/dataset-uta4-nasa-tlx), [UTA4: Time Dataset](https://mimbcd-ui.github.io/dataset-uta4-time), [UTA4: Rates Dataset](https://mimbcd-ui.github.io/dataset-uta4-rates) and [UTA4: Medical Imaging DICOM Files Dataset](https://mimbcd-ui.github.io/dataset-uta4-dicom) pages to provide further information regarding these *datasets* and respective repositories. The *paper* is also available [here](https://www.overleaf.com/read/dcwpwvjgmjxk) (Read Only). A *preprint* version of this paper is available on [ResearchGate](https://www.researchgate.net/publication/340460522_BreastScreening_On_the_Use_of_Multi-Modality_in_Medical_Imaging_Diagnosis) [DOI: [10.13140/RG.2.2.28548.27523](https://www.doi.org/10.13140/RG.2.2.28548.27523)] and [arXiv](https://arxiv.org/abs/2004.03500). The user tests were made in clinical institutions, where clinicians diagnose several patients for a **Single-Modality** *vs* **Multi-Modality** comparison. For example, in these tests, we used both [`prototype-single-modality`](https://github.com/mida-project/prototype-single-modality) and [`prototype-multi-modality`](https://github.com/mida-project/prototype-multi-modality) repositories for the comparison. On the same hand, the hereby *scientific publication* represents the pieces of information of both [BreastScreening](https://BreastScreening.github.io) and [MIDA](https://mida-project.github.io) projects. These projects are research projects that deal with the use of a recently proposed technique in literature: [Deep Convolutional Neural Networks (CNNs)](https://en.wikipedia.org/wiki/Convolutional_neural_network). From a developed User Interface (UI) and *framework*, these deep networks will incorporate [several datasets](https://github.com/MIMBCD-UI/meta/wiki/Datasets) in different modes. For more information about the available *scientific publications* please follow the [Publications](https://github.com/MIMBCD-UI/meta/wiki/Publications) page on the [Wiki](https://github.com/MIMBCD-UI/meta/wiki) of the [`meta`](https://github.com/MIMBCD-UI/meta) information repository. Last but not least, you can find further information on the [Wiki](https://github.com/MIMBCD-UI/avi-2020-short-paper/wiki) in this repository. We also have several demos to see in our [YouTube Channel](https://www.youtube.com/channel/UCPz4aTIVHekHXTxHTUOLmXw), please follow us.
...
Either as something that seems missing or any need for support, just open a [new issue](https://github.com/MIMBCD-UI/avi-2020-short-paper/issues/new). Regardless of being a simple request or a fully-structured feature, we will do our best to understand them and, eventually, solve them.
